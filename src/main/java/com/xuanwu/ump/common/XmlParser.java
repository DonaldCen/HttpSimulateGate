...
public class XmlParser {
     ...
     *
     */
    public void parser(Map data, InputStream is, String dtdFile) throws Exception {
     ...
     * @param doc
     */
    public void parser(Map data, byte[] doc, String dtdFile) throws Exception {
     ...
     * @return
     */
    private void parser(Map data, InputSource sc, String dtdFile) throws Exception {
        // 设置DTD
     ...
     */
    private void parser(Map data, Document doc) throws Exception {
        if (doc == null || !doc.hasChildNodes()) {
            throw new Exception("文档没有节点信息");
        }
     ...
     */
    private void parser(Map data, Node rootNode) throws Exception {
    ...
    private void parserDetail(Map data, String itemName, Node detailNode, int attrSize,
                              NamedNodeMap attrList) throws Exception {
