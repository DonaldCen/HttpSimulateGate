...
public class HttpRequestContext {
    ...
    public HttpRequestContext setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HttpRequestContext addHeader(String name, String value) {
    ...
    public HttpRequestContext addParameterDefine(ParameterDefine parameterDefine) {
    ...
    public HttpRequestContext setUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public HttpRequestContext setMethod(MethodType method) {
        this.method = method;
        return this;
    }
    ...
    public HttpRequestContext setResultClass(Class<?> resultClass) {
    ...
    public HttpRequestContext setResponseType(ResponseType responseType) {
    ...
    public HttpRequestContext setDescription(String description) {
    ...
    public HttpRequestContext addInputData(String key, Object value) {
    ...
    public HttpRequestContext setMultipartDataMap(Map<String, Object> multipartDataMap) {
    ...
    public HttpRequestContext addValidationResult(ErrorMessage errorMessage) {
    ...
    public HttpRequestContext setNameValuePairList(List<NameValuePair> nameValuePairList) {
    ...
    public HttpRequestContext addCookie(String name, String value) {
