...
public class XmlUtil {
    public static Map<String, Object> xmlToMap(File xmlFile) throws HttpSimulateGateException {
        XmlParser parser = new XmlParser();
        Map<String, Object> map = new HashMap<String, Object>();
        try {
            parser.parser(map, FileUtils.readFileToByteArray(xmlFile), null);
        } catch (IOException e) {
            throw new HttpSimulateGateException(e.getMessage(), e);
        }
        return map;
    }

    public static Map<String, Object> xmlToMap(String xml) throws HttpSimulateGateException {
        XmlParser parser = new XmlParser();
        Map<String, Object> map = new HashMap<String, Object>();
